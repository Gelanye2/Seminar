...
graph <- po_latlon_na %>>%
  ...
  lrn("classif.xgboost",
      ...
      max_depth          = 14,
      subsample          = 0.8797397,
      colsample_bytree   = 0.7197727,
      gamma              = 0.15868,
      lambda             = exp(1.00061),
      alpha              = exp(-4.551675),
      min_child_weight   = 1.103049
  )
...
saveRDS(result_imp, "data/predictions_with_imp2.rds")
write.csv(result_imp, "subxg_new3.csv", row.names = FALSE)
