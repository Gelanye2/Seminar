...
base_learners <- list(xgb_tuned, ranger_tuned)
...
write.csv(result_stacking, "result/submission_stacking_multinom12.csv", row.names = FALSE)
print("Submission file 'submission_stacking_multinom.csv' has been generated.")
saveRDS(final_learner, "result/model_stacking_multinom12.rds")
