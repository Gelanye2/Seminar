...
base_learners <- list(xgb_base, xgb_tuned, ranger_base, ranger_tuned,
                      lightgbm_base, kknn_base, catboost_base)
...
write.csv(result_stacking, "result/submission_stacking_multinom5.csv", row.names = FALSE)
print("Submission file 'submission_stacking_multinom.csv' has been generated.")
saveRDS(final_learner, "result/model_stacking_multinom5.rds")
